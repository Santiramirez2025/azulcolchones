...
// ACTUALIZADO CON PRECIOS REALES DEL ANÁLISIS PDF
// ============================================================================
...
interface ComparacionProducto {
  ...
  tamaño: string
  precioML: number
  precioFabrica: number // Precio "A 7 DIAS" que ve el cliente
  ahorro: number
  ahorroPorc: number
  urlML?: string
  imagenML?: string
...
export default function ComparadorMercadoLibre() {
  ...
  const comparaciones: ComparacionProducto[] = [
    ...
    {
      producto: 'Montreaux Pillow Top King',
      tamaño: '200x200x34',
      precioML: 2612000,
    ...
    {
      producto: 'Montreaux Pillow Top Queen',
      tamaño: '200x160x34',
      precioML: 2027000,
    ...
    {
      producto: 'Regno Pillow Top King',
      tamaño: '200x200x29',
      precioML: 1049000,
      precioFabrica: 783921,
      ahorro: 265079,
      ahorroPorc: 25,
      urlML: 'https://www.mercadolibre.com.ar/colchon-piero-regno-pillow-top-king',
      badge: '💎 CALIDAD',
      categoria: 'equilibrio'
    },
    {
      producto: 'Gravita 140',
      tamaño: '190x140x29',
      precioML: 980000,
      precioFabrica: 736057,
      ahorro: 243943,
      ahorroPorc: 25,
      urlML: 'https://www.mercadolibre.com.ar/colchon-piero-gravita-140',
      badge: '🌟 RESORTES',
      categoria: 'equilibrio'
    },
  ]
  ...
  const categoriasConfig = {
    ancla: {
      ...
      bgGradient: 'from-red-950/40 to-orange-950/40'
    },
    equilibrio: {
      badgeGradient: 'from-blue-600 to-blue-700',
      borderColor: 'border-blue-500/50',
      bgGradient: 'from-blue-950/40 to-purple-950/40'
    },
    premium: {
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <header className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-zinc-400 max-w-3xl mx-auto">
            ...
            hasta <strong className="text-green-400">$1.266.156 más baratos</strong> comprando directo de fábrica
          </p>
        </header>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {comparaciones.map((item, index) => (
                <button
                  ...
                  className={`
                    relative px-3 py-3 rounded-xl font-semibold text-xs sm:text-sm
                ...
                >
                  {item.badge && productoActivo === index && (
                    <span className="absolute -top-2 -right-2 px-2 py-0.5 bg-green-500 text-white text-[10px] rounded-full whitespace-nowrap">
                      {item.ahorroPorc}% OFF
                    </span>
                  )}
                  <div className="font-black leading-tight mb-1">{item.producto}</div>
                  <div className="text-[10px] opacity-75">{item.tamaño} cm</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            {/* Columna DERECHA: Azul Colchones */}
            <div className="relative">
              <div className={`bg-gradient-to-br ${categoriaActual.bgGradient} backdrop-blur-sm border-2 ${categoriaActual.borderColor} rounded-2xl p-6 md:p-8 shadow-2xl shadow-green-500/20`}>
                
                {/* Badge Destacado Superior - DINÁMICO */}
                <div className={`absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-2 bg-gradient-to-r ${categoriaActual.badgeGradient} text-white text-sm font-black rounded-full shadow-lg whitespace-nowrap z-10`}>
                ...
                {/* Ahorro DESTACADO - CON ANIMACIÓN */}
                <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-xl p-5 mb-6 text-center shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-950/50 to-purple-950/50 border border-blue-500/30 rounded-2xl p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
              ...
              <div className="flex-shrink-0">
                <span className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-bold rounded-lg shadow-lg">
        ...
        {/* Stats rápidos - ACTUALIZADOS */}
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center hover:border-green-500/50 transition-all duration-300">
            <div className="text-3xl font-black text-green-400 mb-1">Hasta 48%</div>
            <div className="text-xs text-zinc-400">Más barato que ML</div>
          </div>
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center hover:border-blue-500/50 transition-all duration-300">
            <div className="text-3xl font-black text-blue-400 mb-1">7-10</div>
            <div className="text-xs text-zinc-400">Días de entrega</div>
          </div>
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center hover:border-purple-500/50 transition-all duration-300">
            <div className="text-3xl font-black text-purple-400 mb-1">100%</div>
            <div className="text-xs text-zinc-400">Garantía oficial</div>
          </div>
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 text-center hover:border-yellow-500/50 transition-all duration-300">
            <div className="text-3xl font-black text-yellow-400 mb-1">$0</div>
            <div className="text-xs text-zinc-400">Envío gratis</div>
          </div>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <a
            href="#productos"
            className="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all duration-300 hover:scale-105"
          >
