...
export const metadata: Metadata = {
  title: 'Piero Fábrica | Ahorrá 30-40% Comprando Directo | Villa María',
  description: 'El mismo colchón Piero hasta $400.000 más barato que MercadoLibre. 7-10 días de espera = ahorro real. Financiación 12 cuotas sin interés.',
  robots: 'index, follow',
  alternates: {
      ...
      <div className="max-w-screen-2xl mx-auto px-4 py-5">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-base font-bold text-white">30-40% Descuento</p>
      ...
      <div className="relative max-w-screen-2xl mx-auto px-4 py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-zinc-400">
                  ...
                  pero pagás <strong className="text-green-400">30-40% menos</strong>
                </p>
              </div>
            ...
            {/* Columna Derecha: Comparación Visual */}
            <div className="bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm border border-zinc-700/50 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-zinc-400">
                  Mismo producto, misma garantía, <strong className="text-white">muchísimo más barato</strong>
                </p>
              </div>
  ...
  const beneficios = [
    {
      ...
      ahorro: 'Ahorrás 30-40%'
    },
    {
      icon: '⏱️',
      titulo: 'Espera Inteligente',
      descripcion: 'MercadoLibre: 10-15 días. Nosotros: 7-10 días. Casi el mismo tiempo, precio mucho mejor.',
      ahorro: 'Mismo tiempo'
    },
    {
      icon: '✅',
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-zinc-300 italic mb-3">
                "Compré el Nirvana Queen a $951k. En MercadoLibre estaba $1.261k. Me ahorré $310k esperando solo 8 días. Una locura no hacerlo."
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-700/50 rounded-2xl p-8 text-center hover:border-blue-500/50 transition-all">
              ...
              <p className="text-zinc-400">
                Sin intermediarios que inflen el precio un 30-50%
              </p>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-700/50 rounded-2xl p-8 text-center hover:border-green-500/50 transition-all">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">30-40% Más Barato</h3>
              <p className="text-zinc-400">
                Ahorro real de $78.000 a $400.000 según el modelo
              </p>
            </div>
          ...
          <div className="text-center space-y-6">
            ...
            <div className="pt-8 border-t border-zinc-700/30 max-w-2xl mx-auto">
              <div className="flex items-center justify-center gap-3 text-zinc-400">
                ...
                <p className="text-sm">
                  <strong className="text-white">30 días de prueba</strong> • Cambio o devolución sin preguntas
                </p>
              </div>
            </div>
