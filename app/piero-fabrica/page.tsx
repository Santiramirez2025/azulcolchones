...
// ============================================================================
// 4. STICKY CTA MOBILE - SIEMPRE VISIBLE 📱
// ============================================================================

function StickyCTAMobile() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-zinc-900/95 backdrop-blur-lg border-t border-zinc-800 p-3 safe-area-pb">
      <a
...
export default function PieroFabricaPage() {
  return (
    <div className="min-h-screen w-full bg-zinc-950 overflow-x-hidden antialiased">
      ...
      {/* ========================================= */}
      {/* MOBILE STICKY CTA - Siempre visible     */}
      {/* ========================================= */}
      <StickyCTAMobile />
      
      {/* Padding para el sticky CTA en mobile */}
