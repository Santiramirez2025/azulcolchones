// app/cuidado-colchon/page.tsx - ULTRA OPTIMIZED ⚡
'use client'
...
const careStructuredData = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'Cómo Cuidar un Colchón',
  description: 'Guía completa de mantenimiento y cuidado de colchones',
  image: `${BASE_URL}/og-image.jpg`,
  totalTime: 'P1Y',
  tool: [
    { '@type': 'HowToTool', name: 'Aspiradora' },
    { '@type': 'HowToTool', name: 'Protector impermeable' },
    { '@type': 'HowToTool', name: 'Jabón neutro' }
  ],
  step: [
    {
      '@type': 'HowToStep',
      name: 'Usar protector',
      text: 'Colocar un protector transpirable e impermeable desde el primer día'
    },
    {
      '@type': 'HowToStep',
      name: 'Ventilar diariamente',
      text: 'Dejar la cama sin hacer 10-15 minutos cada mañana'
    },
    {
      '@type': 'HowToStep',
      name: 'Girar regularmente',
      text: 'Voltear cada 3 meses los primeros 6 meses, luego girar cada 6 meses'
    },
    {
      '@type': 'HowToStep',
      name: 'Limpiar mensualmente',
      text: 'Aspirar suavemente la superficie con accesorio de tapicería'
    }
  ]
}
...
export default function CuidadoColchonPage() {
  const [activeTab, setActiveTab] = useState<'basico' | 'limpieza' | 'calendario'>('basico')

  // ✅ Optimized tab handler
  const handleTabChange = useCallback((tabId: 'basico' | 'limpieza' | 'calendario') => {
    setActiveTab(tabId)
  }, [])
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(careStructuredData)
        }}
      />
          ...
          <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
              ...
              <div className="space-y-6">
                ...
                <article className="bg-zinc-800/40 border border-zinc-700/50 rounded-xl p-6 md:p-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-3">Productos a evitar</h2>
            ...
            {activeTab === 'calendario' && (
              <div className="space-y-6">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <h2 className="text-xl font-bold text-white">{period.period}</h2>
                      </div>
                      <ul className="space-y-2">
                ...
                {/* Timeline Visual */}
                <article className="bg-zinc-800/40 border border-zinc-700/50 rounded-xl p-6 md:p-8 mt-12">
                  <h2 className="text-2xl font-bold text-white mb-6 text-center">Vida útil esperada</h2>
