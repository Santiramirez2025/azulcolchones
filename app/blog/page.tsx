// app/blog/page.tsx - ULTRA OPTIMIZED ⚡
'use client'
...
import { 
  ...
  Play, Pause, Trophy, Lightbulb
} from 'lucide-react'

// Types
interface RitualStep {
  id: number; title: string; description: string; icon: any
  type: 'info' | 'timer' | 'interactive' | 'journal'
  completed: boolean; relatedArticles: number[]
}

interface DailyProgress {
  date: string; stepsCompleted: number[]; journalEntry: string; breathingCycles?: number
}
...
const INITIAL_STEPS: RitualStep[] = [
  {
    id: 1, title: 'Apaga las pantallas',
    ...
    icon: Moon, type: 'info', completed: false, relatedArticles: [1]
  },
  {
    id: 2, title: 'Respira profundo',
    ...
    icon: Wind, type: 'timer', completed: false, relatedArticles: [2]
  },
  {
    id: 3, title: 'Ajusta la temperatura',
    description: 'La temperatura ideal para dormir es entre 15-19°C. Un ambiente fresco mejora la calidad del sueño profundo.',
    icon: ThermometerSun, type: 'interactive', completed: false, relatedArticles: [3]
  },
  {
    id: 4, title: 'Diario del sueño',
    ...
    icon: BookMarked, type: 'journal', completed: false, relatedArticles: [1]
  }
]
    ...
    try {
      ...
      if (savedProgress) {
        ...
        if (progress.date === today) {
          setRitualSteps(INITIAL_STEPS.map(step => ({
            ...step,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Blog',
            name: 'Blog del Descanso - Azul Colchones',
            description: 'Guías científicas sobre sueño saludable',
            url: 'https://azulcolchones.com/blog',
            publisher: {
              '@type': 'Organization',
              name: 'Azul Colchones'
            }
            ...
            <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-zinc-800/50 border border-zinc-700/50 px-4 py-2 rounded-full mb-6">
                  ...
                  <span className="text-zinc-300 font-medium text-sm">Guía del Descanso Premium</span>
                </div>
        ...
        <section className="w-full border-t border-zinc-800/50">
          <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">Guías esenciales</h2>
              <p className="text-lg text-zinc-400">Información práctica que mejorará tu descanso</p>
            </div>
              ...
              {ESSENTIAL_GUIDES.map((guide) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-3">{guide.excerpt}</p>
