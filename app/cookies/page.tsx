// app/cookies/page.tsx - ULTRA OPTIMIZED ⚡
'use client'
...
const cookiesStructuredData = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Política de Cookies - Azul Colchones Villa María',
  description: 'Política de cookies transparente de Azul Colchones',
...
export default function CookiesPage() {
  ...
  // ✅ Optimized preference updater
  const updatePreference = useCallback((id: 'essential' | 'analytics', value: boolean) => {
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(cookiesStructuredData)
        }}
      />
                    ...
                    >
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          ...
                          onChange={(e) => updatePreference(cookie.id, e.target.checked)}
                          className="sr-only peer"
                          aria-label={`${cookie.title} ${cookie.required ? '(obligatoria)' : ''}`}
                        />
