// app/checkout/success/page.tsx - ULTRA OPTIMIZED ⚡
'use client'
...
// ============================================================================
// METADATA (inline - client component can't export metadata)
// ============================================================================
// Note: Para SEO, considerar crear layout.tsx con metadata si es necesario
...
const successStructuredData = {
  ...
  '@type': 'CheckoutPage',
  name: 'Compra Exitosa - Azul Colchones',
...
function SuccessContent() {
  ...
  const externalReference = useMemo(() => searchParams.get('external_reference'), [searchParams])
  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      try {
        ...
        console.error('[SUCCESS] Error parsing order:', error)
      }
      setLoading(false)
    }
  }, [sessionId, paymentId])
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(successStructuredData)
        }}
      />
      ...
      <div className="min-h-screen pt-24 pb-16 bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            >
              <article className="bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-2xl p-6 border border-blue-500/20 backdrop-blur-sm shadow-xl">
                <Mail className="w-10 h-10 text-blue-400 mb-4 mx-auto" />
                <h2 className="text-lg font-bold text-white mb-2">Email de confirmación</h2>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Vas a recibir los detalles de tu pedido por email
                </p>
              </article>

              <article className="bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-2xl p-6 border border-cyan-500/20 backdrop-blur-sm shadow-xl">
                <Package className="w-10 h-10 text-cyan-400 mb-4 mx-auto" />
                <h2 className="text-lg font-bold text-white mb-2">Procesando pedido</h2>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Estamos preparando tu pedido para el envío
                </p>
              </article>

              <article className="bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-2xl p-6 border border-emerald-500/20 backdrop-blur-sm shadow-xl">
                <Truck className="w-10 h-10 text-emerald-400 mb-4 mx-auto" />
                <h2 className="text-lg font-bold text-white mb-2">Entrega Villa María</h2>
                <p className="text-sm text-zinc-400 leading-relaxed">
            ...
            {orderData && (
              ...
              >
                <h2 className="text-lg font-bold text-white mb-4">Detalles del pedido</h2>
            ...
            >
              <h2 className="text-lg font-bold text-white mb-4">¿Necesitás ayuda?</h2>
