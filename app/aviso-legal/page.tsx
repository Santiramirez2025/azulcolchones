// app/aviso-legal/page.tsx - ULTRA OPTIMIZED ⚡ - Aviso Legal
...
export const metadata: Metadata = {
  title: 'Aviso Legal | Azul Colchones Villa María | Términos y Condiciones',
  description: '⚖️ Aviso legal de Azul Colchones Villa María. Términos de uso, condiciones, propiedad intelectual y normativa de protección al consumidor. Transparencia y cumplimiento legal.',
  
  keywords: [
    // === CORE LEGAL ===
    'aviso legal azul colchones',
    ...
    // === LOCAL ===
    'aviso legal villa maría',
    'términos colchones villa maría',
    'condiciones tienda villa maría',
  ...
  openGraph: {
    title: '⚖️ Aviso Legal | Azul Colchones Villa María',
    description: 'Términos y condiciones | Defensa del consumidor | Cumplimiento legal',
    type: 'website',
    locale: 'es_AR',
...
const legalStructuredData = {
  ...
  '@type': 'WebPage',
  name: 'Aviso Legal - Azul Colchones Villa María',
  description: 'Términos y condiciones legales de Azul Colchones',
  url: `${BASE_URL}/aviso-legal`,
  inLanguage: 'es-AR',
  isPartOf: {
    '@type': 'WebSite',
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(legalStructuredData)
        }}
      />
