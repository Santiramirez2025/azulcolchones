            ...
            <div className="space-y-4 sm:space-y-5 max-w-lg mx-auto">
              <div className="text-center space-y-1.5">
                <div className="inline-flex items-center gap-2 bg-slate-900/90 backdrop-blur-xl border border-slate-700/50 px-3.5 py-1.5 rounded-lg shadow-lg">
                  <span className="text-xl sm:text-2xl font-black text-white tracking-tight">AZUL COLCHONES</span>
                </div>
                ...
                <div className="inline-block w-full max-w-[280px] sm:max-w-xs">
                  <div className="bg-gradient-to-br from-blue-600 to-blue-500 p-[2px] rounded-xl sm:rounded-2xl shadow-2xl shadow-blue-500/20">
                    <div className="bg-slate-900 rounded-[11px] sm:rounded-[15px] px-4 sm:px-5 py-3 sm:py-4">
                      <div className="text-[10px] sm:text-xs text-blue-400 font-semibold uppercase tracking-wider mb-0.5">Desde</div>
              ...
              <div className="space-y-2.5 pt-1">
                <a href="/catalogo" className="group block w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 active:scale-[0.98] text-white px-5 sm:px-6 py-4 sm:py-5 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg shadow-2xl shadow-blue-500/30 transition-all duration-200 touch-manipulation" aria-label="Ver ofertas disponibles de colchones Piero">
                  ...
                  <div className="text-[11px] sm:text-xs text-blue-100 mt-1.5 font-normal">Stock limitado • Entrega inmediata</div>
                </a>

                <a href="/piero-fabrica" className="group block w-full bg-slate-800/50 hover:bg-slate-700/50 active:scale-[0.98] border-2 border-slate-600/40 text-white px-4 sm:px-5 py-3 sm:py-3.5 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base transition-all duration-200 touch-manipulation" aria-label="Solicitar colchón de fábrica Piero">
                  ...
                  <div className="text-[11px] sm:text-xs text-slate-400 mt-0.5">30-40% OFF • 7-10 días</div>
                </a>

                <a href={`https://wa.me/${SITE_CONFIG.whatsappNumber}?text=Hola!%20Quiero%20consultar%20sobre%20colchones%20Piero`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white px-4 sm:px-5 py-3 sm:py-3.5 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base transition-all duration-200 touch-manipulation shadow-lg shadow-emerald-500/20" aria-label="Consultar por WhatsApp">
              ...
              <div className="space-y-8">
                ...
                <div className="inline-block">
                  <div className="bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="mt-4 text-sm text-emerald-400 font-semibold">💳 6 cuotas sin interés</div>
                  </div>
                </div>

                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <a href="/catalogo" className="group relative bg-gradient-to-br from-blue-950/80 to-blue-900/60 backdrop-blur-xl border-2 border-blue-500/30 hover:border-blue-400/60 rounded-xl p-5 transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-blue-500/20" aria-label="Ver outlet de colchones Piero">
                      <div className="absolute -top-2 -right-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-black text-[10px] font-black px-2 py-1 rounded-full uppercase shadow-lg animate-pulse">HOT</div>
                    ...
                    <a href="/piero-fabrica" className="group relative bg-gradient-to-br from-orange-950/80 to-red-900/60 backdrop-blur-xl border-2 border-orange-500/30 hover:border-orange-400/60 rounded-xl p-5 transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-orange-500/20" aria-label="Solicitar colchón de fábrica Piero">
                      <div className="absolute -top-2 -right-2 bg-gradient-to-r from-orange-500 to-red-500 text-white text-[10px] font-black px-2 py-1 rounded-full uppercase shadow-lg">NUEVO</div>
                      <div className="flex items-start gap-3">
                  ...
                  <a href={`https://wa.me/${SITE_CONFIG.whatsappNumber}?text=Hola!%20Quiero%20consultar%20sobre%20colchones%20Piero`} target="_blank" rel="noopener noreferrer" className="w-full inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]" aria-label="Contactar por WhatsApp">
