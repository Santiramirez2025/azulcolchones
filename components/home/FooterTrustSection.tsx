      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-slate-500 text-sm">
            ¿Tenés dudas? <a href="https://wa.me/5493534096566" className="text-blue-400 hover:text-blue-300 font-semibold underline transition-colors">Hablá con nosotros por WhatsApp</a>
          </p>
        </div>
      </div>
    </section>
