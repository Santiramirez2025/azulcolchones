  ...
  return (
    <footer className="relative bg-zinc-950 border-t border-zinc-800/50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute w-[600px] h-[600px] bg-blue-600/3 rounded-full blur-[180px] -bottom-32 left-1/4" />
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 py-8 md:py-10">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm">5-10 años oficial</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm">Villa María y zona</p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-5">
              ...
              <Link href="/" className="inline-block group mb-6" aria-label="Azul Colchones — Inicio">
                <div className="flex items-center gap-3.5">
                  ...
                  <div className="flex flex-col leading-none">
                    <span className="font-black text-white tracking-tight text-[22px]">
                      Azul Colchones
                    </span>
                    <div className="flex items-center gap-1.5 mt-[6px]">
                      <span className="text-[9px] font-semibold text-zinc-500 uppercase tracking-[0.12em]">Villa María</span>
                      <span className="w-[3px] h-[3px] rounded-full bg-zinc-700 flex-shrink-0" />
                      <span className="text-[9px] font-semibold text-zinc-500 uppercase tracking-[0.12em]">Desde 1991</span>
                    </div>
                  </div>
                </div>
              </Link>

              {/* Badge Distribuidor — bloque propio, sin overlap */}
              <div className="inline-flex items-center gap-2.5 px-4 py-2.5 bg-gradient-to-r from-amber-500/10 via-amber-500/15 to-amber-500/10 border border-amber-500/40 rounded-xl mb-6">
                ...
                <div>
                  ...
                  <div className="text-amber-400/80 text-xs font-semibold">PIERO · {yearsOfExperience}+ años</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2">
              ...
              <nav className="space-y-3">
                <Link href="/contacto" className="group flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm">
                  <span className="text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Contacto</span>
                </Link>
                <a href="https://wa.me/5493534096566" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm">
                  <span className="text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>WhatsApp</span>
                </a>
              </nav>
            ...
            <div className="lg:col-span-3">
              ...
              <nav className="space-y-3 mb-6">
                <Link href="/terminos" className="group flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm">
                  <span className="text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Términos</span>
                </Link>
                <Link href="/privacidad" className="group flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm">
                  <span className="text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  <span>Privacidad</span>
                </Link>
                <Link href="/defensa-consumidor" className="group flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm">
                  <span className="text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2.5 text-zinc-400 text-sm">
                  ...
                  <span>Balerdi 855, Villa María, Córdoba</span>
                </div>
                <div className="flex items-start gap-2.5 text-zinc-400 text-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                {['Efectivo', 'Transferencia', 'Tarjetas', 'MercadoPago'].map((method) => (
                  <span
                    key={method}
                    className="px-3 py-1.5 bg-zinc-800/50 border border-zinc-700/50 rounded-md text-xs text-zinc-400 font-medium"
                  >
                    {method}
                  </span>
                ))}
