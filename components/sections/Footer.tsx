...
const BrandIcon = ({ className = "w-10 h-10" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <linearGradient id="footerMoonGradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <rect x="2" y="2" width="44" height="44" rx="12" fill="url(#footerBrandGradient)" />
    <rect x="2" y="2" width="44" height="44" rx="12" fill="url(#footerBrandGradient)" opacity="0.8" />
        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-5">
              ...
              <Link href="/" className="inline-flex items-center gap-3 mb-4 group">
                ...
                <div className="flex flex-col">
                  <div className="flex items-baseline gap-0.5">
                    ...
                    <span className="text-xl font-light leading-none text-blue-400">
                      colchones
                    </span>
                  </div>
              ...
              <div className="inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-amber-950/40 to-orange-950/40 border border-amber-500/30 rounded-xl mb-5">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-bold text-sm rounded-xl transition-all hover:scale-105 shadow-lg shadow-green-500/25 mb-5"
              >
              ...
              <div className="space-y-2 text-sm text-zinc-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>{CONFIG.address}, {CONFIG.location}, {CONFIG.region}</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/piero-fabrica" className="text-sm text-zinc-500 hover:text-white transition-colors">
                    Piero Fábrica
                    <span className="block text-xs text-emerald-400">Hasta 22% OFF</span>
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 py-5">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <p className="text-xs text-zinc-600">
                © {new Date().getFullYear()} Azul Colchones · {CONFIG.location}, {CONFIG.region}
              </p>
